...
class TestAITaskParser:
    ...
    @patch("fsd.core.ai_task_parser.Anthropic")
    def test_parse_simple_task(self, mock_anthropic):
...
"""
    ...
    @patch("fsd.core.ai_task_parser.Anthropic")
    def test_parse_complex_task(self, mock_anthropic):
...
"""
    ...
    def test_parse_invalid_json(self, mock_anthropic):
        ...
        with pytest.raises(AITaskParserError):
            parser.parse_task("Fix bug")

    @patch("fsd.core.ai_task_parser.Anthropic")
    def test_parse_missing_required_fields(self, mock_anthropic):
...
"""
        ...
        # Parse task
        parser = AITaskParser()
        task = parser.parse_task("Fix authentication bug")
